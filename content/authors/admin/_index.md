  ...
  - name: Data Structures & Algorithms
    items:
      ...
      - name: Stacks & Queues
        ...
        percent: 80
        icon: stack
      - name: Trees (Binary Search Trees & Advanced Trees)
        description: ''
        percent: 80
        icon: tree
      ...
      - name: Strings
        ...
        percent: 80
        icon: text
  - name: Computational Geometry & Computational Conformal Geometry
    items:
      - name: Convex Hull Algorithm
        description: 'Quickly constructs the minimal convex hull for a point set.'
        percent: 85
        icon: shape
      - name: Triangulation Algorithm
        description: 'Efficient triangulation of planar point sets.'
        percent: 80
        icon: triangle
      - name: Point Location Algorithm
        description: 'Optimizes query point location within polygons or partitions.'
        percent: 85
        icon: location-dot
      - name: Interval Query Algorithm
        description: 'Efficient querying of dynamic data sets.'
        percent: 75
        icon: search
      - name: Intersection Algorithm
        description: 'Accurately calculates intersections of line segments or polygons.'
        percent: 80
        icon: intersection
      - name: Closest Pair Algorithm
        description: 'Searches for the closest pair of points in a point set.'
        percent: 85
        icon: search-location
  - name: Quantum Computing
    items:
      - name: IBM Qiskit Framework
        description: 'Designing quantum circuits and algorithms using Qiskit.'
        percent: 70
        icon: qiskit
      - name: Quantum Circuit Design
        description: 'Able to design, simulate and implement quantum circuits.'
        percent: 75
        icon: quantum
  - name: Embedded Systems
    items:
      - name: 51 Microcontroller
        description: 'Experienced in development using the 51 microcontroller.'
        percent: 80
        icon: chip
      - name: STM32 Development
        description: 'Familiar with STM32 platform and related tools.'
        percent: 75
        icon: chip
      - name: HarmonyOS (Hongmeng)
        description: 'Knowledgeable in embedded development with HarmonyOS.'
        percent: 70
        icon: software
      - name: Raspberry Pi Autonomous Car
        description: 'Developed autonomous vehicle using Raspberry Pi.'
        percent: 85
        icon: car
  - name: Network Security & Administration
    items:
      - name: Kali Linux, Wireshark, Nmap
        description: 'Experience using network security tools.'
        percent: 80
        icon: shield
      - name: TCP/IP, HTTP, DNS Protocols
        description: 'Familiar with basic computer networking protocols.'
        percent: 75
        icon: network
      - name: Network Design & Configuration
        description: 'Capable of designing and configuring networks.'
        percent: 80
        icon: plug
      - name: Huawei Routers & Switches
        description: 'Experienced in configuring Huawei network devices.'
        percent: 70
        icon: router
  - name: Operating Systems & Linux
    items:
      - name: Windows, Linux
        description: 'Experienced with both Windows and Linux operating systems.'
        percent: 85
        icon: desktop
      - name: Linux System Configuration & Management
        description: 'Proficient in configuring and managing Linux systems.'
        percent: 80
        icon: terminal
      - name: Shell Scripting & System Optimization
        description: 'Skilled in writing shell scripts for system optimization.'
        percent: 75
        icon: script
